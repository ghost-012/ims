				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align="right">
							<button type="button" name="add" id="addStudent" data-bs-toggle="modal" data-bs-target="#userModal" class="btn btn-primary bg-gradient btn-sm rounded-0"><i class="far fa-plus-square"></i> New Student</button>
						</div>
					</div>					   
        	...
        	<div class="modal-dialog modal-dialog-centered  rounded-0">
        			<div class="modal-content rounded-0">
						...
						<div class="modal-body">
							<div class="container-fluid">
								<form method="post" id="studentForm">
									...
									<input type="hidden" name="btn_action" id="btn_action" value="studentAdd" />
									<div class="mb-3">
									...
									<div class="mb-3">
										...
										<input type="text" name="balance" id="balance" class="form-control rounded-0" required />
									</div>
									<div class="mb-3">
						...
						<div class="modal-footer">
							<button type="submit" name="action" id="action" class="btn btn-sm rounded-0 btn-primary" form="studentForm" >Save</button>
